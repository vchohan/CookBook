    ...
    private void setupRecipeTipsCardView() {
        ...
        mRunnable = new Runnable() {
            ...
            public void run() {
                ...
                recipeTip.startAnimation(AnimationUtils.loadAnimation(TabbedActivity.this, android.R.anim.slide_in_left));
                mPosition++;
...
//            });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent setupIntent = new Intent(TabbedActivity.this, TabbedActivity.class);
