...
public class MainRecyclerViewAdapter extends RecyclerView.Adapter<MainRecyclerViewAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public LinearLayout mLinearLayout, mRecyclerCardView;

        public ViewHolder(View v) {
            super(v);
            mLinearLayout = (LinearLayout) v.findViewById(R.id.recycler_card_view);
            mRecyclerCardView = (LinearLayout) v.findViewById(R.id.recycler_card_view);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.mRecyclerCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                String recipe = mDataSet.get(position);
//                Toast.makeText(mContext, recipe, Toast.LENGTH_SHORT).show();
                Intent cardViewIntent = new Intent(mContext, RecipeViewHolderActivity.class);
                cardViewIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
